...
<body>
                ...
                <div class="modal-body">
                    <form>
                        <div class="row form-group">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-auto">
                        ...
                        <div class="form-group row">
                            <div class="offset-sm-4 offset-md-3  offset-lg-2 col-auto">
    ...
    <header class="jumbotron">
        <div class="container">
            <div class="row row-header">
                ...
                <div class="col-12 col-sm-3 align-self-center">
                    <a class="btn btn-sm btn-warning btn-block nav-link" data-toggle="modal"
                        data-target="#reserveModal">
                        Reserve Table
                    </a>
                    <!-- Boton con tooltip -->
                    <!-- <a class="btn btn-sm btn-warning btn-block nav-link" data-html="true" data-toggle="tooltip"
                        data-placement="bottom" title="Or Call us at <br><strong>+852123456789</strong>" role="button"
                        href="#form">Reserve Table</a> -->
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="container">
                    ...
                    <div role="listbox" class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption d-none d-md-block">
                                ...
                                <p class="">Featuring mouthwatering combinations with a choice of five different salads,
                                    six
                                    enticing
                                    appetizers,
            ...
            <div class="col col-sm col-md">
                <div class="media">
                    <div class="media-body">
                        ...
                        <p class="">Featuring mouthwatering combinations with a choice of five different salads, six
                            enticing
                            appetizers,
        ...
        <div class="row row-content align-items-center">
            ...
            <div class="col col-sm order-sm-first  col-md">
                <div class="media">
                    <img src="./img/alberto.png" alt="alberto" class="d-flex mr-3 align-self-center img-thumbnail">
                    <div class="media-body">
